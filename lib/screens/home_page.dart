      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              "The bluetooth State ==> ${state != null ? state.toString().substring(15) : 'not available'}.",
            ...
            ElevatedButton(
              ...
              onPressed: Platform.isAndroid
                  ...
                  : null,
              child: const AppText('Ouvrir votre Bluetooth', weight: FontWeight.w700, color: Colors.white,),
            ),
          ],
        ),
      ),
              ...
              StreamBuilder<List<BluetoothDevice>>(
                ...
                builder: (c, snapshot) => Column(
                  children: snapshot.data!
                    ...
                    subtitle: AppText(d.id.toString()),
                ...
                builder: (c, snapshot){
                  ...
                  return Column(
                    children: snapshot.data!
                        .map(
                          (r) => ListTile(
                        title: AppText("${r.device.id} - ${r.device.name}"),
                        subtitle: StreamBuilder<BluetoothDeviceState>(
                          stream: r.device.state,
                          builder: (context, snapshot) {
                            return AppText(snapshot.data!.name);
                          }
                        ),
